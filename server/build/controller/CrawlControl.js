...
var CrawlerControl = /** @class */ (function () {
    function CrawlerControl() {
    }
    CrawlerControl.prototype.getData = function (req, res) {
        // console.log("getData")
    ...
    CrawlerControl.prototype.showData = function (req, res) {
        try {
            console.log("getData");
    ...
    ], CrawlerControl.prototype, "getData", null);
    __decorate([
        ...
        __metadata("design:paramtypes", [Object, Object]),
        __metadata("design:returntype", void 0)
    ], CrawlerControl.prototype, "showData", null);
    CrawlerControl = __decorate([
        decorator_1.controller('/api')
    ], CrawlerControl);
    return CrawlerControl;
}());
exports.CrawlerControl = CrawlerControl;
