...
var superagent_1 = __importDefault(require("superagent")); //use superagent to translate typescript to javascript
var Crawler = /** @class */ (function () {
    function Crawler(url, analyzer) {
        this.url = url;
        this.analyzer = analyzer;
        this.filePath = path_1.default.resolve(__dirname, '../../data/case.json');
        this.initSpiderProcess();
    }
    Crawler.prototype.getOriginalHtml = function () {
    ...
    Crawler.prototype.initSpiderProcess = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getOriginalHtml()];
                    case 1:
                        html = _a.sent();
